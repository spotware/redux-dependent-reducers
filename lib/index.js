...
var DependentReducers = (function () {
    ...
    DependentReducers.prototype.createDependency = function (dependencyParams) {
        var _this = this;
        var initialState = dependencyParams.initialState, reducerFn = dependencyParams.reducerFn, dependencies = dependencyParams.dependencies;
    ...
    DependentReducers.prototype.combine = function (stateShape, preloadedState) {
        var _this = this;
...
var DependentReducer = (function () {
    ...
    DependentReducer.prototype.updateCurrentState = function (state) {
        if (typeof this.currentState === 'object') {
            this.currentState = lodash_1.merge({}, this.currentState, state);
        }
        else {

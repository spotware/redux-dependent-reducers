...
var DependentReducers = (function () {
    ...
    DependentReducers.prototype.createDependency = function (newDependencyParams) {
        var _this = this;
        var initialState = newDependencyParams.initialState, reducerFn = newDependencyParams.reducerFn, dependencies = newDependencyParams.dependencies;
